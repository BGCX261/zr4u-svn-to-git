...
<div id="doc3">
    <div id="bd">
        <ul class="navBar ui-widget-content ui-corner-all"><li>&#187 <a href="#" title="开发调试">开发调试</a></li><li>&#187 <a href="/develop/sandbox" title="调试沙箱">调试沙箱</a></li></ul>
        <div id="respTips" class="ui-corner-all"><?php isset($returnStruct['msg']) && print($returnStruct['msg']);?></div>
        <p>&nbsp;</p>
        <p>returnStruct:</p>
        <pre><?php isset($returnStruct) && var_export($returnStruct);?></pre>
        <p>&nbsp;</p>
        <p>requestData:</p>
        <pre><?php isset($requestData) && var_export($requestData);?></pre>
        <p>&nbsp;</p>
    </div>
    <div id="ft">
        <p>-</p>
